...
<SCRIPT type="text/javascript">
	function f_selectCheck(){
		  var obj = document.getElementById("sel");
		  var index = obj.selectedIndex;
		  var val = obj.options[index].value;
		  if(val == "0"){
		   	document.form1.begin.disabled = "true";
		  	document.form1.end.disabled = "true";
		  	document.form1.begin.value = "请先选择一个下属人员";
		  	document.form1.end.value = "请先选择一个下属人员";
		  	document.form1.end.disabled = "true";
		  	document.form1.status.disabled = "true";
		  }else{
		  	if(document.form1.begin.disabled){
		  		document.form1.begin.disabled = !document.form1.begin.disabled;
		  		document.form1.begin.value = "";
		  	} 
		  	if(document.form1.end.disabled){
		  		document.form1.end.disabled = !document.form1.end.disabled;
		  		document.form1.end.value = "";
		  	}
		  	if(document.form1.status.disabled){
		  		document.form1.status.disabled = !document.form1.status.disabled;
		  	}
		  } 
	}
</SCRIPT>
...
<script language="javascript">
  ...
  cdr.showMoreDay = true;
    ...
    <div id="report">
    <s:form action="queryReportAuditing_ReportAuditAction" name="form1">
	<table id="option">
	<tr>
	...
	<tr>
		...
		<td>
		<s:select list="empOptions" listKey="id" listValue="name" id="sel" onchange="f_selectCheck();"
