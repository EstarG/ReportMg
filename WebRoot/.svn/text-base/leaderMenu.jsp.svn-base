  ...
  <div style="margin-top: 4px;margin-right: 0px; height: 492px;">
    <div id="content">
		...
		<div id="queryAudit" class="queryDetails">
	     &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<img src="images/tip5.jpg"/>&nbsp;<a href="initAudit_ReportAuditAction?emp=${ session.user.id }" target="content" style="color:#1874CD;text-decoration:none"><font face="微软雅黑">日报审核</font></a><br />
		</div>
	   ...
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/tip5.jpg"/>&nbsp;<a href="queryByDate_ReportAction" target="content" style="color:#1874CD;text-decoration:none"><font face="微软雅黑">按日期查询</font></a><br />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<img src="images/tip5.jpg"/>&nbsp;<a href="queryByProject_ReportAction" style="color: #1874CD; text-decoration: none"
					target="content">按项目查询</a>
				<br />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<img src="images/tip5.jpg"/>&nbsp;<a href="queryAllReport_ReportAction?deptId = ${ session.user.id }" style="color: #1874CD; text-decoration: none"
