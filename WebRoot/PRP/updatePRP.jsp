...
<SCRIPT type="text/javascript">
  ...
  <body style="font-family: 微软雅黑" "bgcolor="#DCDCDC">
   <div id="addPRP">
  <s:form action="updatePrp_PrpAction" name="form1">
	<table id="option" border="2" bgcolor="#DCDCDC">
	<tr>
		<th colspan="4"> 修改prp阶段</th>
	</tr>
	<s:hidden name="id" value="%{prpMap.id}"></s:hidden>
	<tr>
		<td style="width:150px; color:#FF0000">PRP缩写</td>
		<td>
		<s:textfield name="abbreviate" value="%{prpMap.ab}" onblur="f_checkPrpAb(this.value)"></s:textfield>
		<div id = "isokPrpAb" style="color:red;font-size:12px;font-weight:normal"></div>
		</td>
		<td style="width:150px; color:#FF0000">PRP阶段名称</td>
		<td>
		<s:textfield name="name" value="%{prpMap.name}" onblur="f_checkPrpName(this.value)"></s:textfield>
	...
	<tr>
		...
		<td colspan="3">
		<s:textarea rows="8" cols="70" name="remarks" value="%{prpMap.remarks}"></s:textarea>
		</td>
	</tr>	
	<tr>
